 ...
 * @author srush
 */
public class RequestLicenseForManufacturingJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form RequestLicenseForManufacturingJPanel
     */
    public RequestLicenseForManufacturingJPanel(JPanel userProcessContainer,Network network,UserAccount userAccount) {
        initComponents();
    ...
    private void sendRequestButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sendRequestButtonActionPerformed
        ...
        e.getProductManagementOrganization().getSentWorkQueue().getWorkRequestList().add(licenseManagerWorkRequest);

        JOptionPane.showMessageDialog(null, "License Request Sent");
        }
